    ...
    if(didMount) {
        return(
            <>
              ...
              <div id = "background" style={{paddingBottom:"13rem"}} className=" break-words parallaxDiv bg-[url(/butterfly.png)]">
                
                <div className="textAnim font-extrabold text-2xl md:text-4xl text-center mt-[26vh] mb-[2em] cursor-pointer">お前はもう<Yang>死</Yang>んでいる
                  <div className="mt-3 text-5xl md:text-6xl">Background</div>
                </div>

                <Line val="10"/>
                <div className="flex justify-center">
                  <div className="md:hover:scale-105 cursor-pointer leftAnim font-extrabold bg-[rgba(0,0,0,0.5)] md:p-3 rounded-xl w-[100%] md:w-[80%] text-center mt-[1em] mb-[1em]"><Blue>誕生</Blue><br/><div className="text-[1.3em] mt-1">The Beginning</div>
                ...
                <Line val="10"/>
                <div className="flex justify-center">
                  <div className="md:hover:scale-105 cursor-pointer rightAnim font-extrabold bg-[rgba(0,0,0,0.5)] md:p-3 rounded-xl w-[100%] md:w-[80%] text-center mt-[1em] mb-[1em]"><Green>生活</Green><br/><div className="text-[1.3em] mt-1">The Dream</div>
                ...
                <Line val="10"/>
                <div className="flex justify-center">
                  <div className="md:hover:scale-105 cursor-pointer leftAnim font-extrabold bg-[rgba(0,0,0,0.5)] md:p-3 rounded-xl w-[100%] md:w-[80%]  text-center mt-[1em] mb-[1em]"><Red><Yin>陰</Yin>陽</Red><br/><div className="text-[1.3em] mt-1">Perseverance</div>
                  <div className="mt-3 font-normal">
                ...
                <Line val="10"/>
                <div className="flex justify-center">
                  <div className="md:hover:scale-105 cursor-pointer siyaal font-extrabold bg-[rgba(0,0,0,0.5)] md:p-3 rounded-xl w-[100%] md:w-[80%] text-center mt-[1em] mb-[1em]"><Red>無限の彼方へ</Red><br/><div className="text-[1.3em] mt-1">The Present And The Future</div>
