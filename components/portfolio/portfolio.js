    ...
    if(didMount){
        return (
            <>  
                ...
                <Parallax id="portfolio" className="bg-[url(/street.webp)]">
                    ...
                    <div className="textAnim prnt mt-[0em] p-1 rounded-[0.5em] grid grid-cols-1 grid-rows-1 md:grid-cols-2 md:grid-rows-2 gap-2 ">
                        ...
                        <a target = "_blank" href="https://hackaduck.anirbanhalder.social/" className="prnt2">
                          <div className="chld" >
                        ...
                        <a target = "_blank" href="https://devsdungeon.anirbanhalder.social/" className="prnt2">
                          <div className="chld" >
